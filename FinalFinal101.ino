...
void LeftHandSetUp(){
  ...
  // set center to be zero 
  matrix[mazeSize/2][mazeSize/2]= 0;
  matrix[mazeSize/2][mazeSize/2 -1]= 0;
  matrix[mazeSize/2 -1][mazeSize/2]= 0;
  matrix[mazeSize/2 -1][mazeSize/2 -1]= 0;
